...
(eval-exp (andalso (bool #t) (const 7)))

(define (double e) (multiply e (const 2)))
(define (list-product es) (if (null? es) (const 1) (multiply (car es) (list-product (cdr es)))))
(eval-exp (list-product (list (const 2) (const 4) (const 6))))

(define test (andalso (eq-num (double (const 24)) (list-product (list (const 2) (const 4) (const 6)))) (bool #t) ))
(eval-exp test)
